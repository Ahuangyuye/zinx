...
type SyncPid struct {
	...
	Pid int32 `protobuf:"varint,1,opt,name=Pid,proto3" json:"Pid,omitempty"` // 服务器新生成的玩家ID
}
...
func (x *Postion) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Postion) ProtoMessage() {}

func (x *Postion) ProtoReflect() protoreflect.Message {
	mi := &file_msg_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Postion.ProtoReflect.Descriptor instead.
func (*Postion) Descriptor() ([]byte, []int) {
	return file_msg_proto_rawDescGZIP(), []int{1}
}

func (x *Postion) GetX() float32 {
	if x != nil {
		return x.X
	}
	return 0
...
type BroadCast struct {
	...
	Tp  int32 `protobuf:"varint,2,opt,name=Tp,proto3" json:"Tp,omitempty"` // 【  [1:世界聊天] [2:玩家位置] [3：动作][ 4:动作之后的坐标更新] 】
...
type BroadCast_P struct {
	P *Postion `protobuf:"bytes,4,opt,name=p,proto3,oneof"` // 广播玩家的具体位置
}
...
type Player struct {
	...
	Pid int32    `protobuf:"varint,1,opt,name=Pid,proto3" json:"Pid,omitempty"`
	P   *Postion `protobuf:"bytes,2,opt,name=P,proto3" json:"P,omitempty"`
}
...
var file_msg_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x50, 0x69, 0x64, 0x22, 0x41, 0x0a, 0x07,
	0x50, 0x6f, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0c, 0x0a, 0x01, 0x58, 0x18, 0x01, 0x20, 0x01,
	...
	0x90, 0x01, 0x0a, 0x09, 0x42, 0x72, 0x6f, 0x61, 0x64, 0x43, 0x61, 0x73, 0x74, 0x12, 0x10, 0x0a,
	...
	,
	...
	0x65, 0x72, 0x52, 0x02, 0x70, 0x73, 0x42, 0x0a, 0x5a, 0x03, 0x2f, 0x70, 0x62, 0xaa, 0x02, 0x02,
...
var file_msg_proto_depIdxs = []int32{
	1, // 0: pb.BroadCast.p:type_name -> pb.Postion
	1, // 1: pb.Player.P:type_name -> pb.Postion
